...
func (e errorLog) Write(p []byte) (n int, err error) {
	...
	f, err := os.OpenFile("/root/logs/logs.txt", os.O_APPEND|os.O_CREATE|os.O_WRONLY, 0666)
	if err != nil {
...
var (
	...
	KafkaLogger   = log.New(errorLog{}, "PRODUCER: ", log.Ldate|log.Ltime|log.Lshortfile|log.Lmicroseconds)
)
